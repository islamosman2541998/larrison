! function (t)
{
	...
	function n(e)
	{
		1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (t("body").removeAttr("data-layout-mode"), t("#dark-mode-switch").prop("checked", !1), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e && (t("#light-mode-switch").prop("checked", !1), t("body").attr("data-layout-mode", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch"))
        // 1 == t("#rtl-mode-switch").prop("checked") ? (t("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), t("#app-style").attr("href", "assets/css/app-rtl.min.css"), t("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : (t("html").removeAttr("dir"), t("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), t("#app-style").attr("href", "assets/css/app.min.css"))
	}
	...
	t("#side-menu").metisMenu(), t("#vertical-menu-btn").on("click", function (e)
		...
		}), window.sessionStorage && ((s = sessionStorage.getItem("is_visited")) ? (t(".right-bar input:checkbox").prop("checked", !1), t("#" + s).prop("checked", !0), n(s)) : sessionStorage.setItem("is_visited", "light-mode-switch")), t("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch").on("change", function (e)
		{
			n(e.target.id)
		...
		{
			t("#status").fadeOut(), t("#preloader").delay(100).fadeOut("slow")
		})
}(jQuery);
