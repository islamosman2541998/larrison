...
Route::group([
    ...
    Route::get('parent-categories/{slug}', [CategoryController::class, 'parentCategories'])->name('parent.categories');
    
    Route::get('category/{slug}/products', [CategoryController::class, 'categoryProducts'])->name('category.products');
