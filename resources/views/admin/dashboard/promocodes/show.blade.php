                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]"
                                                                           disabled value="{{ $product->transNow->slug}}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    ...
                                                                    {{--                                                                              disabled> {{ $product->transNow->description }} </textarea>--}}
                                        ...
                                        <div class="accordion-item border rounded">
                                            ...
                                            <div id="collapseTwo{{ $key }}"
                                                ...
                                                <div class="accordion-body">
                                                        ...
                                                        @if( $product->transNow )
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                           ...
                                                                           value="{{$product->transNow->meta_title}}"
                                                                           id="title{{ $key }}">
                                                                </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    ...
                                                                    {{--                                                                          disabled> {{ $product->transNow->meta_desc }} </textarea>--}}
                                                                    {!! $product->transNow->meta_desc !!}
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="{{ $locale }}[meta_key]"
                                                                              class="form-control description"
                                                                              disabled> {{$product->transNow->meta_key }} </textarea>
                                                    ...
                                                    {{--                                                                <textarea name="{{ $locale }}[meta_description]"--}}
                                                    {{--                                                                          class="form-control description"--}}
                                                    {{--                                                                          disabled> {{ @$product->trans->where('locale',$locale)->first()->meta_description }} </textarea>--}}
                                                    {{--                                                                @if($errors->has( $locale . '.meta_description'))--}}
                                                    {{--                                                                    <span--}}
                                                    {{--                                                                        class="missiong-spam">{{ $errors->first( $locale . '.meta_description') }}</span>--}}
                                                    {{--                                                                @endif--}}
                                                    ...
                                                    {{--                                                                <textarea name="{{ $locale }}[meta_key]"--}}
                                                    {{--                                                                          class="form-control description"--}}
                                                    {{--                                                                          disabled> {{ @$product->trans->where('locale',$locale)->first()->meta_key }} </textarea>--}}
                                                    {{--                                                                @if($errors->has( $locale . '.meta_key'))--}}
                                                    {{--                                                                    <span--}}
                                                    {{--                                                                        class="missiong-spam">{{ $errors->first( $locale . '.meta_key') }}</span>--}}
                                                    {{--                                                                @endif--}}
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" disabled type="number" step="any"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label for="example-number-twitter" class="col-sm-2  col-form-label">
                                                                @lang('products.created_by')</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" disabled type="text"
                                                                       placeholder="@lang('products.created_by')"
                                                                       name="created_by"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @forelse($product->occasions as $occa)
                                                                <span class="badge bg-primary">{{$occa->transNow->title}}
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @if($product->productCat )
                                                                <span class="badge bg-orange">{{$product->productCat->trans[0]->title}}
