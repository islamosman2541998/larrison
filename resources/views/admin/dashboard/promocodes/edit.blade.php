...
@section('title', trans('admin.edit_promocode'))
@section('title_page', trans('admin.edit_promocode'))
            ...
            <div class="col-8 offset-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="promo-form" action="{{ route('admin.promocodes.update', $promo->id) }}" method="POST">
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label for="code" class="form-label">@lang('promocodes.code')</label>
                                <input type="text" name="code" id="code" value="{{ old('code', $promo->code) }}"
                            ...
                            <div class="mb-3">
                                <label for="uses_left" class="form-label">@lang('promocodes.uses_left')</label>
                                <input type="number" name="uses_left" id="uses_left" min="0"
                                    value="{{ old('uses_left', $promo->uses_left) }}"
                                    class="form-control @error('uses_left') is-invalid @enderror">
                                @error('uses_left')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="start_at" id="start_at"
                                    value="{{ old('start_at', \Carbon\Carbon::parse($promo->start_at)->format('Y-m-d\TH:i')) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="end_at" id="end_at"
                                    value="{{ old('end_at', \Carbon\Carbon::parse($promo->end_at)->format('Y-m-d\TH:i')) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title[ar]" id="title_ar"
                                    value="{{ old('title.ar', optional($promo->trans->where('locale', 'ar')->first())->title) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title[en]" id="title_en"
                                    value="{{ old('title.en', optional($promo->trans->where('locale', 'en')->first())->title) }}"
