...
@section('title', trans('admin.edit_orders'))
@section('title_page', trans('admin.edit_orders', ['name' => @$orders->identifier]))
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="row" method="post" action="{{ route('admin.orders.update', $orders->id) }}"
                                ...
                                {{-- other info --}}
                                <div class="col-md-4">
                                    <div class="accordion mt-4 mb-4" id="accordionExample_info">
                                        <div class="accordion-item border rounded">
                                            <h2 class="accordion-header" id="headingOne_info">
                                                <button class="accordion-button fw-medium" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseOne_info"
                                                    aria-expanded="true" aria-controls="collapseOne_info">
                                                    {{ trans('admin.settings') }}
                                                </button>
                                            </h2>
                                            <div id="collapseOne_info" class="accordion-collapse collapse show"
                                                aria-labelledby="headingOne_info" data-bs-parent="#accordionExample_info">
                                                <div class="accordion-body">
                                                            ...
                                                            <select class="form-select form-select-sm select2"
                                                                ...
                                                                @foreach (\App\Enums\OrderStatusEnum::values() as $val)
                                                                    <option {{ $orders->status == $val ? 'selected' : '' }}
                                                                        value="{{ $orders->status == $val ? null : $val }}">
                                                                        @lang('admin.' . $val) </option>
                                                                @endforeach
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-select form-select-sm select2"
                                                                name="shipped_price"
                                                                value="{{ $orders->shipped_price ?? 0 }}">

                                                        </div>
                                                        @if ($errors->has('shipped_price'))
                                                            <span class="missiong-spam">{{ $errors->shipped_price }}</span>
                                                        @endif
                                                    </div>
                                                            ...
                                                            <select class="form-select form-select-sm select2"
                                                                ...
                                                                @foreach (\App\Enums\ShippingEnum::values() as $val)
                                                                    <option
                                                                        ...
                                                                        value="{{ $orders->shipped_status == $val ? null : $val }}">
                                                                        @lang('admin.' . $val) </option>
                                                                @endforeach
                                        ...
                                        <div class="accordion-item border rounded">
                                            ...
                                            <div id="collapseOne22all" class="accordion-collapse collapse show mt-3"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="container">
                                                        @php
                                                            $arr = [null => '', 0 => __('admin.no'), 1 => __('admin.yes')];
                                                            $arrPlace = [null => '', 0 => __('admin.home'), 1 => __('admin.office')];
                                                        @endphp
                                                            ...
                                                            <div class="col-md-12 col-md-6  col-lg-4 card cardInfo">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <span class="spanText">@lang('admin.delivery_place')</span> :
                                                                        {{ $arrPlace[$orders->extraOrderDetails?->delivery_place] }}
                                                                    </li>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <span class="spanText">@lang('admin.image')</span> :
                                                                            <img src="{{ asset($orders->image) }}" width="100" height="100">
                                                                    </li>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            @foreach ($orders->orderStatus as $item)
                                                                <tr
                                                                    ...
                                                                    <td class="p-2"><a
                                                                            ...
                                                                            href="{{ route('admin.deleteOrderStatus', ['order_id' => $orders->id, 'order_status_id' => $item->id]) }}">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    @foreach ($orders->shippingOrderStatus as $item)
                                                                        @if ($item->shipped_status)
                                                                            <div onclick="showNext('{{ 'delete_button_' . $item->id }}' , this)"
                                                                                ...
                                                                                <p
                                                                                    style="color: {{ \App\Enums\ShippingEnum::colors[$item->shipped_status] ?? '' }}">
                                                                                    {{ __('admin.' . App\Enums\ShippingEnum::values()[$item->shipped_status]) }}
                                                                                    <br><span>{{ $item->created_at }}</span>
                                                                                </p>
                                                                                <a style="display: none"
                                                                                    id='{{ 'delete_button_' . $item->id }}'
                                                                                    class="btn btn-outline-danger btn-sm"
                                                                                    href="{{ route('admin.deleteShippingOrderStatus', ['order_id' => $orders->id, 'shipping_order_status_id' => $item->id]) }}">
                                                                                    <i class="fa fa-trash"></i>
                                                                                </a>
