...
@section('title', trans('footerMenu.show_menu'))
@section('title_page', trans('footerMenu.show', ['name' => @$footer_menu->trans->where('locale',$current_lang)->first()->title]) )
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ $footer_menu->trans->where('locale',$current_lang)->first()->title }}"
                                                                        id="name{{ $key }}">
                                                                </div>
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]"
                                                                        value="{{ $footer_menu->trans->where('locale',$current_lang)->first()->slug }}"
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class=" row mb-3">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <p class="h2 text-primary ">{{ @$footer_menu->parent ?@$footer_menu->parent->title: "__"  }}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3 title-section">
                                                                    <label for="example-text-input"
                                                                        class="col-sm-6 col-form-label">{{ trans('footerMenu.type') }}</label>
                                                                    <div class="col-sm-12">
                                                                ...
                                                                <div class="row mb-3 title-section" id="static-url"
                                                                    @if (@$footer_menu->type != App\Enums\MunesEnums::STATIC) style="display: none;" @endif>
                                                                    <label for="example-text-input"
                                                                        class="col-sm-6 col-form-label">{{ trans('footerMenu.url') }}</label>
                                                                    <div class="col-sm-12">
                                                                        <input class="form-control" id="static_url" disabled
                                                                            type="text" name="url"
                                                                            value="{{ @$footer_menu->url ?? old('url') }}">
                                                                ...
                                                                <div id="dynamic-url"
                                                                    @if (@$footer_menu->type != App\Enums\MunesEnums::DYNAMIC) style="display: none;" @endif>
                                                                    <div class="row mb-3 title-section">
                                                                        <label for="example-text-input"
                                                                            class="col-sm-6 col-form-label">{{ trans('footerMenu.type_url') }}</label>
                                                                        <div class="col-sm-12">
                                                                            <select class="form-select form-select-sm" disabled
                                                                                ...
                                                                                @foreach (App\Enums\UrlTypesEnum::values() as $enumTypes)
                                                                                    <option value="{{ $enumTypes }}" 
                                                                                        {{ $enumTypes == @$footer_menu->dynamic_table ? 'selected' : '' }}>
                                                                                        {{ $enumTypes }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <label class="col-sm-3 col-form-label"
                                                                            for="available">{{ trans('footerMenu.status') }}</label>
                                                                        <div class="col-sm-10">
