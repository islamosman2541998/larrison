...
@section('title_page', trans('articles.edit', ['name' => @$article->trans->where('locale',
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea id="description{{ $key }}" name="{{ $locale }}[description]"> {{ @$article->trans->where('locale', $locale)->first()->description }} </textarea>
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select name="tags[]"
                                                            ...
                                                            @foreach ($tags as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ in_array($item->id, $article->tags->pluck('tag_id')->toArray()) ? 'selected' : '' }}>
                                                                    {{ $item->trans->where('locale', $current_lang)->first()->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-check form-switch" name="feature" type="checkbox"
                                                        ...
                                                        {{ @$article->feature == 1 ? 'checked' : '' }} value="1">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-check form-switch" name="news_ticker"
                                                        type="checkbox" id="switch2" switch="success"
                                                        {{ @$article->news_ticker == 1 ? 'checked' : '' }} value="1">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-check form-switch" name="status" type="checkbox"
                                                        ...
                                                        {{ @$article->status == 1 ? 'checked' : '' }} value="1">
