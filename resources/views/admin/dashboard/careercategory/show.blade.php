...
@section('title_page', trans('tags.show', ['name' => @$careerCategory->trans->where('locale',$current_lang)->first()->title]) )
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            @foreach ($languages as $key => $locale)
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10"> 
                                                                        <input class="form-control" type="text" name="{{ $locale }}[title]" disabled  value="{{ $careerCategory->trans->where('locale',$locale)->first()->title }}" id="title{{ $key }}">
                                                                    </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        value="{{ $careerCategory->sort }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- feature ------------------------------------------------------------------------------------- --}}
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="feature"
                                                                    type="checkbox" id="switch1" switch="success"
                                                                     value="1" {{ @$careerCategory->feature == 1? 'checked':'' }} disabled>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="status"
                                                                    type="checkbox" id="switch3" switch="success"
                                                                     value="1" {{ @$careerCategory->status == 1? 'checked':'' }} disabled>
