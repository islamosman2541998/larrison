...
@section('title_page', trans('admin.edit_careercategory', ['name' => @$careerCategory->trans->where('locale',$current_lang)->first()->title]) )
                ...
                <div class="col-12 m-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.career_category.update', $careerCategory->id) }}" method="post"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="{{ $locale }}[title]"
                                                                        value="{{ $careerCategory->trans->where('locale',$locale)->first()->title }}"
                                                                        id="title{{ $key }}">
                                                                </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="feature"
                                                                    ...
                                                                    value="1"
                                                                    {{ @$careerCategory->feature == 1 ? 'checked' : '' }}>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="status"
                                                                    ...
                                                                    value="1" {{ @$careerCategory->status == 1 ? 'checked' : '' }}>
