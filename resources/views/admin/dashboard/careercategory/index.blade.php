...
@section('title', trans('admin.career_category'))
@section('title_page', trans('admin.career_category'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body  search-group">
                        <div class="row">
                            <div class="col-md-12 text-end mb-2">
                                <a href="{{ route('admin.career_category.create') }}"
                                    class="btn btn-outline-success btn-sm">@lang('admin.create')</a>
                            </div>
                        </div>
                        {{-- Start Form search --}}
                        <form action="{{ route('admin.career_category.index') }}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3 mb-2">
                                    <input type="test" value="{{ old('description', request()->input('description')) }}"
                                        name="description" placeholder="{{ trans('admin.description') }}"
                                        class="form-control">
                                </div>
                                <div class="col-md-3 mb-2">
                                ...
                                <div class="search-input col-md-2">
                                    <button class="btn btn-primary btn-sm" type="submit"><i class="fas fa-search"
                                            title="{{ trans('button.search') }}"> </i></button>
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.career_category.index') }}"
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{ route('admin.career_category.actions') }}" method="post">
                            @csrf
                        </form>
                            ...
                            <table id="main-datatable"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($items as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.career_category.update-status', $item->id) }}"
                                                    ...
                                                    @if ($item->feature == 1)
                                                        <a href="{{ route('admin.career_category.update-featured', $item->id) }}}"
                                                    ...
                                                    @else
                                                        <a href="{{ route('admin.career_category.update-featured', $item->id) }}"
                                                            ...
                                                            class="btn btn-xs btn-outline-secondary btn-sm m-1"><i
                                                                class="fa fa-star"></i></a>
                                                    @endif
                                                    <a href="{{ route('admin.career_category.show', $item->id) }}"
                                                        title="@lang('admin.show')"
                                                        class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="{{ route('admin.career_category.edit', $item->id) }}"
                                        ...
                                        @include('admin.dashboard.careercategory.delete')
                                    @endforeach
