                ...
                <form action="{{route('admin.pages.index')}}" method="get">
                    <div class="row">
                        ...
                        <div class="search-input col-md-2">
                            ...
                            <a class="btn btn-warning btn-sm" href="{{route('admin.pages.index')}}" title="{{ trans('button.reset') }}"><i class="refresh ion ion-md-refresh"></i></a>
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            <tbody>
                                @forelse($items as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{asset($item->image)}}" target="_blank">  <img src="{{asset($item->image)}}" alt="" style="width: 50px"></a>
                                        </td>
