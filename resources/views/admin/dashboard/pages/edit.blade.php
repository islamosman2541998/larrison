...
@section('title_page', trans('pages.edit', ['name' => @$page->translate($locale)->title]) )
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea id="content{{ $key }}"
                                                                                  name="{{ $locale }}[content]"> {{ @$page->trans->where('locale', $locale)->first()->content }} </textarea>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-10 mb-2">
                                                                            <textarea
                                                                                ...
                                                                                class="form-control description"> {{ @$page->trans->where('locale', $locale)->first()->meta_description }} </textarea>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-10 mb-2">
                                                                            <textarea name="{{ $locale }}[meta_key]"
                                                                                      class="form-control description"> {{ @$page->trans->where('locale', $locale)->first()->meta_key }} </textarea>
