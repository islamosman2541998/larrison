                                                            ...
                                                            <div class=" row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    @foreach (App\Enums\MenuPositionEnums::values() as $pos)
                                                                        <input type="radio" class="position"
                                                                            id="position" name="position"
                                                                            value="{{ $pos }}" required>
                                                                        <label
                                                                            for="html">{{ $pos }}</label><br>
                                                                    @endforeach
                                                                        ...
                                                                        <select class="form-select form-select-sm"
                                                                            ...
                                                                            @foreach (App\Enums\UrlTypesEnum::values() as $enumTypes)
                                                                                <option value="{{ $enumTypes }}"
                                                                                    {{ $enumTypes == old('dynamic_table') ? 'selected' : '' }}>
                                                                                    {{ $enumTypes }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        @if ('type')
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-check form-switch"
                                                                            name="status" type="checkbox" id="switch4"
                                                                            switch="success" checked value="1">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#dynamic-type").on('change', function() {
                    let val = $(this).val();
                    // if (val == "all specialities") {
                    //     $('#get-dynamic-urls').find('option').remove().end();
                    //     $("#get-dynamic-urls").append('<option selected value="/specialities">/specialities</option>');
                    // } else if (val == "all doctors") {
                    //     $('#get-dynamic-urls').find('option').remove().end();
                    //     $("#get-dynamic-urls").append('<option selected value="/doctors">/doctors</option>');
                    ...
                    // } else if (val == "all gallery") {
                    //     $('#get-dynamic-urls').find('option').remove().end();
                    //     $("#get-dynamic-urls").append('<option selected value="/gallery">/gallery</option>');
                    // } else if (val == "all videos") {
                    //     $('#get-dynamic-urls').find('option').remove().end();
                    //     $("#get-dynamic-urls").append('<option selected value="/videos">/videos</option>');
