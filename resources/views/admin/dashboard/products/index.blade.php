...
@section('title', trans('products.show_products'))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="search-input col-md-2">
                                        ...
                                        <a class="btn btn-success btn-sm" href="{{ route('admin.products.index') }}"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img onclick="window.open(this.getAttribute('src') , '_blank')"
                                                    width="50" height="50"
                                                    src="{{ asset($item->path() . $item->image) }}" />
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.products.update-status', $item->id) }}"
                                                    ...
                                                    @if ($item->feature == 1)
                                                        <a href="{{ route('admin.products.update-featured', $item->id) }}"
