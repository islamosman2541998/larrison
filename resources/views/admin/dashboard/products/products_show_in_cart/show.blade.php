...
@section('title', trans('products_of_car_only.show_product_category'))
@section('title_page', trans('products_of_car_only.show', ['name' =>    @$product->transNow?->title   ]) )
            ...
            <div class="row">
                <div class="col-12 m-3">
                    <div class="row mb-3 text-end">
                        <div>
                            <a href="{{ route('admin.show_in_cart_product_list') }}"
