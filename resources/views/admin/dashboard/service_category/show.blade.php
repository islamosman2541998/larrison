                        ...
                        <div class="card-body">
                            <form class="row" method="post"
                                ...
                                <div class="col-md-8">
                                    ...
                                    @if($service_category->galleryGroup && $service_category->galleryGroup->images && $service_category->galleryGroup->images->count() )
                                        {{-- images Gellary  --}}
...
{{--                                                                </button>--}}
                                                            ...
                                                            <div class="btn " data-bs-toggle="modal" data-bs-target="#myModal">
                                                              {{ $service_category->galleryGroup  && isset($service_category->galleryGroup->transNow) ? $service_category->galleryGroup->transNow->title : ''}}
                                                            </div>
