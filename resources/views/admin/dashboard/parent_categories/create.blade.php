...
@section('title', trans('parent_category.create'))
@section('title_page', trans('parent_category.create'))
            ...
            <div class="col-12 m-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.parent_category.store') }}" method="post"
                                ...
                                <div class="col-md-8">
                                    ...
                                    @foreach ($languages as $key => $locale)
                                        <div class="accordion mt-4 mb-4 bg-primary"
                                             id="accordionExample_first{{ $locale }}">
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="example-text-input"
                                                                ...
                                                                {{ trans('products.description') . trans('lang.' . Locale::getDisplayName($locale)) }}
                                                            </label>
                                                            <div class="col-sm-10">
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    @foreach ($languages as $key => $locale)
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="example-text-input"
                                                                   class="col-sm-2 col-form-label">
                                                                {{ trans('products.meta_title') . trans('lang.' . Locale::getDisplayName($locale)) }}
                                                            </label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="example-text-input"
                                                                   class="col-sm-2 col-form-label">
                                                                {{ trans('products.meta_desc') . trans('lang.' . Locale::getDisplayName($locale)) }}
                                                            </label>
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control"
                                                                          name="{{ $locale }}[meta_desc]">{{ old($locale . '.meta_desc') }}</textarea>
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="example-text-input"
                                                                   class="col-sm-2 col-form-label">
                                                                {{ trans('products.meta_key') . trans('lang.' . Locale::getDisplayName($locale)) }}
                                                            </label>
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control"
                                                                          name="{{ $locale }}[meta_key]">{{ old($locale . '.meta_key') }}</textarea>
                                                            </div>
                                                            ...
                                                            <select multiple
                                                                ...
                                                                @forelse($productCategories as $pCat)
                                                                    <option value="{{ $pCat->id }}"
                                                                        {{ in_array($pCat->id, old('product_categories', [])) ? 'selected' : '' }}>
