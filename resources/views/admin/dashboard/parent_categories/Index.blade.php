...
@section('title', trans('parent_category.parent_categories'))
@section('title_page', trans('parent_category.parent_categories'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body search-group">
                        <div class="row">
                            <div class="col-md-12 text-end mb-2">
                                <a href="{{ route('admin.parent_category.create') }}"
                                   class="btn btn-outline-success btn-sm">@lang('admin.create')</a>
                            </div>
                        </div>

                        {{-- Start Form search --}}
                        <form action="{{ route('admin.parent_category.index') }}" method="get">
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <input type="text" value="{{ old('title', request()->input('title')) }}"
                                           name="title" placeholder="{{ trans('products.title') }}"
                                           class="form-control">
                                </div>
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.parent_category.index') }}">
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{ route('admin.parent_category.actions') }}" method="post">
                            @csrf
                        </form>
                        ...
                        <div class="table-responsive">
                            <table id="main-datatable"
                                ...
                                <tr>
                                    ...
                                    <th>@lang('parent_category.sub_categories_count')</th>
                                ...
                                @foreach ($items as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-info">{{ $item->productCategories->count() }}</span>
                                        </td>
                                        <td>{{ $item->sort }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                @if($item->status == 1)
                                                    <a href="{{ route('admin.parent_category.update-status', $item->id) }}"
                                                ...
                                                @if($item->feature == 1)
                                                    <a href="{{ route('admin.parent_category.update-featured', $item->id) }}"
                                                ...
                                                <a href="{{ route('admin.parent_category.show', $item->id) }}"
                                                   title="@lang('admin.show')"
                                                   class="btn btn-xs btn-outline-info btn-sm m-1">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.parent_category.edit', $item->id) }}"
                                    ...
                                    @include('admin.dashboard.parent_categories.delete')
                                @endforeach
