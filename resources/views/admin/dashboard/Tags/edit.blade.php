...
@section('title_page', trans('tags.edit_tags', ['name' => @$tag->trans->where('locale',$current_lang)->first()->title]) )
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="{{ $locale }}[title]"
                                                                        value="{{ $tag->trans->where('locale',$locale)->first()->title }}"
                                                                        id="title{{ $key }}">
                                                                </div>
                                                            ...
                                                            {{-- <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ $tag->trans->where('locale',$locale)->first()->meta_title }}"
                                                                        id="title{{ $key }}">
                                                                </div>
                                                    ...
                                                    <div class="accordion-body"> --}}
                                                        ...
                                                        {{-- @if ($tag->background_image != null)
                                                            <div class="col-12">
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-12">
                                                                        <a href="{{ asset($tag->background_image) }}"
                                                                            target="_blank">
                                                                            <img src="{{ asset($tag->background_image) }}"
                                                                                alt="" style="width:100%">
                                                                        </a>
                                                                    </div>
                                                                </div>
