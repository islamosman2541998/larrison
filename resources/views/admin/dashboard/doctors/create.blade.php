...
@section('title', trans('doctors.create_doctors'))
@section('title_page', trans('doctors.create_doctor'))
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        {{-- appointments ------------------------------------------------------------------------------------- --}}
                                                        <div class="row mb-3 mt-3">
                                                            <label for="example-text-appointments" class="col-sm-2 col-form-label"> @lang('admin.appointments_in')
                                                                {{ trans('lang.' .Locale::getDisplayName($locale)) }} </label>
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="appointments{{ $key }}" name="{{ $locale }}[appointments]"> {{ old($locale . '.appointments') }} </textarea>
                                    ...
                                    <div class="accordion-item border rounded">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        <label for="example-number-image" col-form-label>
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('admin.phone')" name="phone" value="{{ old('phone') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- email ------------------------------------------------------------------------------------- --}}
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('admin.address')" name="address" value="{{ old('address') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- degree ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('admin.degree')" name="degree" value="{{ old('degree') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- facebook ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('admin.facebook')" name="facebook" value="{{ old('facebook') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- twitter ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('admin.twitter')" name="twitter" value="{{ old('twitter') }}">
                                                        </div>
                                                    </div>
                                                </div>
