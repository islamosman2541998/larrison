...
@section('title_page', trans('statistic.show_statistic'))
            ...
            <div class="col-12">
                <div class="card">
                        ...
                        <form action="{{ route('admin.statistic.index') }}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.statistic.index') }}"><i
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{ route('admin.statistic.actions') }}" method="post">
                            @csrf
                        </form>
                            ...
                            <table id="main-datatable"
                                ...
                                <tbody>
                                    ...
                                    @foreach (@$items as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.statistic.update-status', $item->id) }}"
                                                    ...
                                                    @if ($item->feature == 1)
                                                        <a href="{{ route('admin.statistic.update-featured', $item->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.statistic.show', $item->id) }}"
                                                        title="@lang('admin.show')"
                                                        class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                            class="fas fa-eye"></i></a>


                                                    <a href="{{ route('admin.statistic.edit', $item->id) }}"
                                        ...
                                        @include('admin.dashboard.statistic.delete')
                                    @endforeach
