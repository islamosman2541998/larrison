...
@section('title', trans('gallery.show_galleries'))
@section('title_page', trans('gallery.show', ['name' => @$gallery->trans->where('locale', $current_lang)->first()->title]) )
            ...
            <div class="row">
                <div class="col-12 m-3">
                    <div class="row mb-3 text-end">                                
                        <div>
                            <a href="{{ route('admin.gallery.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        {{-- title ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10"> 
                                                                    <input class="form-control" type="text" name="{{ $locale }}[title]"  disabled value="{{ @$gallery->trans->where('locale',$locale)->first()->title}}" id="title{{ $key }}">
                                                                </div>
                                                        ...
                                                        {{-- slug ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]" disabled value="{{ @$gallery->trans->where('locale',$locale)->first()->slug}}" id="slug{{ $key }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]" disabled> {{ @$gallery->trans->where('locale',$locale)->first()->description }} </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="content{{ $key }}" name="{{ $locale }}[content]" disabled> {{ @$gallery->trans->where('locale',$locale)->first()->content }} </textarea>
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            {{-- meta_title_ ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-control" type="text" name="{{ $locale }}[meta_title]"  disabled value="{{ @$gallery->trans->where('locale',$locale)->first()->meta_title}}" id="title{{ $key }}">
                                                                    </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea name="{{ $locale }}[meta_description]" class="form-control description" disabled> {{ @$gallery->trans->where('locale',$locale)->first()->meta_description }} </textarea>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea  name="{{ $locale }}[meta_key]" class="form-control description" disabled> {{ @$gallery->trans->where('locale',$locale)->first()->meta_key }} </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-sm-12">
                                                                <a href="{{ asset( $gallery->image) }}" target="_blank">
                                                                    <img src="{{asset( $gallery->image)}}" alt=""  style="width:100%">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {{-- sort ------------------------------------------------------------------------------------- --}}
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" disabled type="number"disabled placeholder="@lang('articles.sort'):" id="example-number-input" value="{{ $gallery->sort }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    {{-- feature ------------------------------------------------------------------------------------- --}}
