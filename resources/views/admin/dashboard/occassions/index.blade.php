...
@section('title', trans('occasions.show_occassions'))
@section('title_page', trans('occasions.show_occassions'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body  search-group">
                        ...
                        {{-- Start Form search --}}
                        <form action="{{route('admin.occasions.index')}}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('admin.occasions.index')}}"><i
...
{{--                                                        class="fa fa-file"></i></a>--}}
                                            ...
                                            @if($item->status == 1)
                                                ...
                                                <a href="{{ route('admin.occasions.show', $item->id) }}"
                                                   title="@lang('admin.show')"
                                                   class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                        class="fas fa-eye"></i></a>


                                                <a href="{{ route('admin.occasions.edit',$item->id) }}"
