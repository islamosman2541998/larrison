...
@section('title', trans('occasions.show_products_occassions'))
@section('title_page', trans('occasions.show_products_occassions'))
                    ...
                    <div class="card-body  search-group">
                        <div class="row">
                            <div class="col-md-12 text-end mb-2">
                                <a href="{{ route('admin.occasions.create.products') . "?occ_type=products" }}"
                                   class="btn btn-outline-success btn-sm">@lang('admin.create')</a>
                            </div>
                        </div>
                        {{-- Start Form search --}}
                        <form action="{{route('admin.occasions_products_index.index')}}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3 bg-success mb-2 d-none">
                                    <select class="form-select" name="type" aria-label=".form-select-sm example">
                                        <option
                                            value="0" selected {{ old('type', request()->input('type')) != 1 && old('status', request()->input('type')) != null? "selected":"" }}> @lang('admin.products') </option>
                                    </select>
                                </div>
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('admin.occasions_products_index.index')}}"><i
...
{{--                                                        class="fa fa-file"></i></a>--}}
                                            ...
                                            @if($item->status == 1)
                                                ...
                                                <a href="{{ route('admin.occasions.show', $item->id) . '?occ_type=products'}}"
                                                   title="@lang('admin.show')"
                                                   class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                        class="fas fa-eye"></i></a>


                                                <a href="{{ route('admin.occasions.edit',$item->id) . '?occ_type=products' }}"
