...
@section('title', trans('occasion_group_gallerys.show_occassions'))
@section('title_page', trans('occasion_group_gallerys.show_occassions'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body  search-group">
                        <div class="row">
                            <div class="col-md-12 text-end mb-2">
                                <a href="{{ url('admin/occasion_group_gallerys/'.$id. '/create ' )  }}"
                                   class="btn btn-outline-success btn-sm">@lang('admin.create')</a>
                            </div>
                        </div>
                        {{-- Start Form search --}}
                         <form action="{{url('admin/occasion_group_gallerys/' . $id)}}" method="get">
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <input type="test" value="{{ old('title', request()->input('title')) }}"
                                           name="title" placeholder="{{ trans('occasion_group_gallerys.title') }}"
                                           class="form-control">
                                </div>
                                <div class="col-md-3 mb-2">
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{url('admin/occasion_group_gallerys/' .  $id)}}"><i
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{route('admin.occasion_group_gallerys.actions' ,['occ_id' => $id])}}" method="post">
                            ...
                            <table id="main-datatable"
                                ...
                                @foreach ($items as $key => $item)
                                     <tr>
                                        ...
                                        <td> @if ($item->mainImage ?  $item->mainImage->image : '' )  <img width="50" height="50" src="{{$item->mainImage-> pathInView('occasions')}}" > @endif </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                @if($item->status == 1)
                                                    <a href="{{ route('admin.occasion_group_gallerys.update-status',  $item->id  )}}"
...
{{--                                                @if($item->featured == 1)--}}
{{--                                                    <a href="{{ route('admin.occasion_group_gallerys.update-featured', $item->id )}}"--}}
...
{{--                                                @endif--}}
                                                ...
                                                <a href="{{ route('admin.occasion_gallery.show',['occ_id' => $id , 'id' => $item->id]) }}"
                                                   title="@lang('admin.show')"
                                                   class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                        class="fas fa-eye"></i></a>


                                                <a href="{{ route('admin.occasion_gallery.edit',['occ_id' => $id , 'id' => $item->id])}}"
                                    ...
                                    @include('admin.dashboard.occassions.occasion_gallery.delete' , ['occ_id' => $id , 'id' => $item->id ] )
...
{{--                        @if(  request()->occasion && request()->occasion > 0)--}}

{{--                        <a class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" href="{{\LaravelLocalization::localizeURL('admin/occasions/' . $id)}}">back</a>--}}
{{--                            @else--}}
{{--                            <a class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" href="{{\LaravelLocalization::localizeURL('admin/occasions' )}}">back</a>--}}
...
{{--                        --}}
                        ...
                        @if(  $occ_type === 0)
                            ...
                            <a class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" href="{{\LaravelLocalization::localizeURL( route('admin.occasions_products_index.index'))}}">back</a>
                        @elseif( $occ_type === 1)
                            <a class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" href="{{\LaravelLocalization::localizeURL(route('admin.occasions_services_index.index') )}}">back</a>
