...
@section('title_page', trans('reviews.edit', ['name' => @$review->customer_name]))
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            @if ($errors->has(  'customer_name'))
                                                                <span
                                                                    class="missiong-spam">{{ $errors->customer_name }}</span>
                                                            @endif
                                                        </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    ...
                                                                    @if ($errors->has( 'description'))
                                                                        <span
                                                                            class="missiong-spam">{{ $errors->description }}</span>
                                                                    @endif
                                                                </div>
