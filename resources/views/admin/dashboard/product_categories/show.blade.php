...
@section('title', trans('product_category.show_product_category'))
@section('title_page', trans('product_category.show_product_category', ['name' => $category->trans ?  @$category->trans->where('locale', $current_lang)->first()->title : '']) )
                                        ...
                                        <div class="accordion-item border rounded">
                                            ...
                                            <div id="collapseTwo{{ $key }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    {{--                                                                <input class="form-control" type="text"--}}
                                                    {{--                                                                       name="{{ $locale }}[meta_title]" disabled--}}
                                                    {{--                                                                       value="{{ @$category->trans->where('locale',$locale)->first()->meta_title}}"--}}
                                                    {{--                                                                       id="title{{ $key }}">--}}
                                                    {{--                                                            </div>--}}
                                                    {{--                                                            @if($errors->has( $locale . '.meta_title'))--}}
                                                    {{--                                                                <span--}}
                                                    ...
                                                    {{--                                                                <textarea name="{{ $locale }}[meta_description]"--}}
                                                    {{--                                                                          class="form-control description"--}}
                                                    {{--                                                                          disabled> {{ @$category->trans->where('locale',$locale)->first()->meta_description }} </textarea>--}}
                                                    {{--                                                                @if($errors->has( $locale . '.meta_description'))--}}
                                                    {{--                                                                    <span--}}
                                                    {{--                                                                        class="missiong-spam">{{ $errors->first( $locale . '.meta_description') }}</span>--}}
                                                    {{--                                                                @endif--}}
                                                    ...
                                                    {{--                                                                <textarea name="{{ $locale }}[meta_key]"--}}
                                                    {{--                                                                          class="form-control description"--}}
                                                    {{--                                                                          disabled> {{ @$category->trans->where('locale',$locale)->first()->meta_key }} </textarea>--}}
                                                    {{--                                                                @if($errors->has( $locale . '.meta_key'))--}}
                                                    {{--                                                                    <span--}}
                                                    {{--                                                                        class="missiong-spam">{{ $errors->first( $locale . '.meta_key') }}</span>--}}
                                                    {{--                                                                @endif--}}
...
{{--                                                            <div class="row">--}}
{{--                                                                @if( $category?->galleryGroup?->images)--}}
...
{{--                                                                                    --}}{{--                                                                                   href="{{\LaravelLocalization::localizeURL(route('admin.product_category.destroy_product_gallery_image' , $image->id))}}">  <i class="fa fa-trash"></i>  </a>--}}
...
{{--                                                        --}}{{--                                                                        <br>--}}
{{--                                                        --}}{{--                                                                        <h6 class="mt-2">  @lang('products.sort')  : {{$image->sort}} </h6>--}}
