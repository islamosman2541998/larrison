...
@section('title', trans('product_category.product_categories'))
@section('title_page', trans('product_category.product_categories'))
...
{{--                                </div>--}}
{{--                                <div class="col-md-3 mb-2">--}}
{{--                                        <input  class="form-control" type="text"  name="occasions" value="{{old('occasions', request()->input('occasions'))}}" >--}}
...
{{--                                 </div>--}}
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('admin.product_category.index')}}"><i
                    ...
                    <div class="card-body mt-0 pt-0">
                                                <form id="update-pages" action="{{route('admin.product_category.actions')}}" method="post">
...
{{--                                        </td>--}}
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                @if($item->status == 1)
                                                    <a href="{{ route('admin.product_category.update-status', $item->id )}}"
                                                ...
                                                @if($item->feature == 1)
                                                    <a href="{{ route('admin.product_category.update-featured', $item->id )}}"
                                                ...
                                                <a href="{{ route('admin.product_category.show', $item->id) }}"
                                                   title="@lang('admin.show')"
                                                   class="btn btn-xs btn-outline-info btn-sm m-1"><i
                                                        class="fas fa-eye"></i></a>


                                                <a href="{{ route('admin.product_category.edit',$item->id) }}"
